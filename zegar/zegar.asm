...
wypisz0				proc
			...
			mov		linia_dolna,	50
			add		linia_dolna,	ax
			rysuj_linie_poz		linia_gorna,	linia_lewa,	linia_prawa,	kolor
			rysuj_linie_poz		linia_dolna,	linia_lewa,	linia_prawa,	kolor
			rysuj_linie_pion	linia_lewa,	linia_gorna,	linia_dolna,	kolor
			rysuj_linie_pion	linia_prawa,	linia_gorna,	linia_dolna,	kolor
...
wypisz2				proc
			...
			add		linia_dolna,	ax
			rysuj_linie_poz		linia_gorna,	linia_lewa,	linia_prawa,	kolor
			rysuj_linie_poz		linia_srodkowa,	linia_lewa,	linia_prawa,	kolor
			rysuj_linie_poz		linia_dolna,	linia_lewa,	linia_prawa,	kolor
			rysuj_linie_pion	linia_lewa,	linia_srodkowa,	linia_dolna,	kolor
			rysuj_linie_pion	linia_prawa,	linia_gorna,	linia_srodkowa,	kolor
...
wypisz4				proc
			...
			add		linia_dolna,	ax
			rysuj_linie_poz		linia_srodkowa,	linia_lewa,	linia_prawa,	kolor
			rysuj_linie_pion	linia_lewa,	linia_gorna,	linia_srodkowa,	kolor
			rysuj_linie_pion	linia_prawa,	linia_gorna,	linia_dolna,	kolor
...
wypisz5				proc
			...
			rysuj_linie_poz		linia_dolna,	linia_lewa,	linia_prawa,	kolor
			rysuj_linie_pion	linia_lewa,	linia_gorna,	linia_srodkowa,	kolor
			rysuj_linie_pion	linia_prawa,	linia_srodkowa,	linia_dolna,	kolor
...
rysuj_czarne_tlo			proc
			...
			mov		linia_dolna,	50
			add		linia_dolna,	ax
			rysuj_linie_poz		linia_gorna,	linia_lewa,	linia_prawa,	0
			rysuj_linie_poz		linia_srodkowa,	linia_lewa,	linia_prawa,	0
			rysuj_linie_poz		linia_dolna,	linia_lewa,	linia_prawa,	0
			rysuj_linie_pion	linia_lewa,	linia_gorna,	linia_dolna,	0
			rysuj_linie_pion	linia_prawa,	linia_gorna,	linia_dolna,	0
