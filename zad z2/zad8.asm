...
start:
    ...
    petla:  
        ...
        push ax                         ; al dodane na stos
        inc si                          ; inkrementuj si (wykorzystanyu jako indeks tablicy)
    ...
    koniec:
        ...
        int 21h                         ; wywołanie przerwania 
; wpisanie znaków ze stosu do bufora LIFO
            mov bx, 0                       ; wpisanie si do bx
        ze_stosu:
            pop ax		                    ; wartość ze stosu do ax
            mov [BUFOR+bx], al              ; wpisanie znaku z rejestru al do bufora
            inc bx                          ; inkrementuj bx
            dec si                          ; inkrementacja si
            cmp si, 0
        jnz ze_stosu
        mov ah, 09h
        xor dx, dx
